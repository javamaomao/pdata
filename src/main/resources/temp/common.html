...
<div class="container body">
    <div class="main_container">
        <div th:fragment="left_col" class="col-md-3 left_col">
            <div class="left_col scroll-view">
                <div class="navbar nav_title" style="border: 0;">
                    <a href="/index.html" class="site_title"><i class="fa fa-paw"></i> <span>私域数据</span></a>
                </div>
                        ...
                        <ul class="nav side-menu">
                            ...
                            <li class="active"><a><i class="fa fa-home"></i> 用户获取 <span
                                ...
                                <ul class="nav child_menu" style="display: block;">
                                    ...
                                    <li><a><i class="fa fa-edit"></i> 推广码招募活动 <span
                                            class="fa fa-chevron-down"></span></a>
                                        <ul class="nav child_menu">
                                            <li><a href="/form.html">活动列表</a></li>
                                            <li><a href="/form.html">创建活动</a></li>
                                    ...
                                    <li><a><i class="fa fa-edit"></i> 固定触点码招募活动 <span class="fa fa-chevron-down"></span></a>
                                        <ul class="nav child_menu">
                                            <li><a href="/form.html">活动列表</a></li>
                                            <li><a href="/form.html">创建活动</a></li>
                                        </ul>
